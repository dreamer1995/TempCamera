...
namespace Bind
{
	...
	{
	public:
		Texture(Graphics& gfx, const std::string& path, UINT slot = 0, UINT shaderIndex = 0b1u);
		...
		static std::string GenerateUID(const std::string& path, UINT slot = 0, UINT shaderIndex = 0b1u);
